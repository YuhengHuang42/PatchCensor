...
#python -u mask_bn.py --data_dir "/drive/partImageNet/" --model bagnet17 --dataset PartImageNet --patch_size 32 --m #mask-bn with bagnet17 on cifar
#python -u mask_ds.py --data_dir "/drive/partImageNet/" --dataset PartImageNet --patch_size 32 --ds #ds for imagenet
