...
"""
python3 -u train_other.py --gpu 0 \
--dataset FOOD101 \
--num-classes 101 --data-dir $data_dir \
--save_dir $output_dir --batch-size 160 --epochs 30
#--resume results/FOOD101/save/resnet_FOOD101_original/checkpoints/best.pth \
"""
...
def main():
    ...
    if args.n_gpu is not None:
        #warnings.warn('You have chosen a specific GPU(s). This will completely '
        #              'disable data parallelism.')
        warnings.warn("Disable data parallelism.")
    ...
    if args.multiprocessing_distributed:
        ...
        main_worker(args.n_gpu, ngpus_per_node, args)
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.gpu is not None:
        print("Use GPU: {} for training".format(args.n_gpu))
    ...
    train_loader = eval("{}DataLoader".format(args.dataset))(
                    ...
                    split='train',
                    model_type="bagnet") # Model type is used for normalization config
...
def validate(val_loader, model, criterion, args):
    ...
    with torch.no_grad():
        ...
        for i, all_data in enumerate(val_loader):
            images = all_data[0]
            target = all_data[1]
            if args.gpu is not None:
                images = images.cuda(args.gpu, non_blocking=True)
